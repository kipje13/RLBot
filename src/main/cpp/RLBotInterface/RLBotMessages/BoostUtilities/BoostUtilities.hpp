...
namespace GameFunctions {
	...
	public:
		SharedMemReader(const char* sharedMemName, const char* mutexName): 
			sharedMem(boost::interprocess::open_only, sharedMemName, boost::interprocess::read_only),
			mutex(boost::interprocess::open_only, mutexName) 
		{ }
